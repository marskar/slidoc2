...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"slidoc2","description":"Use Python, Pypandoc, and Pandoc to create HTML slides from source files."}'
	test -f README.rst || echo "Slidoc2" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/slidoc2.git
